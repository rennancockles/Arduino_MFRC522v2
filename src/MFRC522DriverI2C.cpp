 ...
 */
void MFRC522DriverI2C::PCD_WriteRegister(
 ...
 */
void MFRC522DriverI2C::PCD_WriteRegister(
    const MFRC522Constants::PCD_Register reg, ///< The register to write to. One of the PCD_Register enums.
 ...
 * The interface is described in the datasheet section 8.1.4.
 */
byte MFRC522DriverI2C::PCD_ReadRegister(
  ...
  // while(!_wire.available()); // Dangerous! Might block! Wait for byte to be available. TODO timeout
  // detection.
 ...
 */
void MFRC522DriverI2C::PCD_ReadRegister(
    const PCD_Register reg, ///< The register to read from. One of the PCD_Register enums.
